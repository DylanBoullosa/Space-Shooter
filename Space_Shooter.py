...
def main():
   ...
   while run:
       ...
       if keys[pygame.K_SPACE]:
           ...
           bullet_y = player.y
           bullet = pygame.Rect(bullet_x + 15, bullet_y + 20, BULLET_WIDTH - 30, BULLET_HEIGHT - 40)
       ...
       for bullet in bullets[:]:
           for enemy in enemies[:]:
               ...
               small_hitbox = pygame.Rect(hitbox_x, hitbox_y, hitbox_width, hitbox_height)


               if bullet.colliderect(small_hitbox):
                   bullets.remove(bullet)
       ...
       hitbox_width = PLAYER_WIDTH * 0.25
       hitbox_height = PLAYER_HEIGHT * 0.25
       hitbox_x = player.x + (PLAYER_WIDTH - hitbox_width) / 3
       ...
       for enemy in enemies:
           ...
           if player_hitbox.colliderect(small_hitbox):
               hit = True
               break
